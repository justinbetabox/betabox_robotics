...
function normalizeHealthState(status) {
    ...
    const visionAvailable = firstDefined(
        objectValue(status, "hardware", "vision", "service_available"),
        false,
    );
...
function clearTimestamp() {
    element("hud-updated").textContent = "Could not retrieve platform status.";
}
...
function renderStatus(status) {
    ...
    const temperature = firstDefined(
        objectValue(status, "system_health", "temperature", "celsius"),
    );

    const memoryPercent = firstDefined(
        objectValue(status, "system_health", "memory", "used_percent"),
    );

    const diskPercent = firstDefined(
        objectValue(status, "system_health", "disk", "used_percent"),
    );
    ...
    element("hud-control").textContent = controlText;

    element("hud-vision").textContent = visionText;

    element("detail-battery").textContent = batteryText;

    element("detail-temperature").textContent = temperatureText;

    element("detail-control").textContent = controlText;

    element("detail-network").textContent = networkText;

    element("detail-jupyter").textContent = jupyterText;

    element("detail-memory").textContent = formatPercent(memoryPercent);

    element("detail-disk").textContent = formatPercent(diskPercent);

    element("detail-vision").textContent = visionText;
...
function renderDisconnected() {
    ...
    element("hud-battery").textContent = "--";

    element("hud-control").textContent = "Unknown";

    element("hud-vision").textContent = "Unknown";

    element("detail-battery").textContent = "--";

    element("detail-temperature").textContent = "--";

    element("detail-control").textContent = "Unknown";

    element("detail-network").textContent = "Unknown";

    element("detail-jupyter").textContent = "Unknown";

    element("detail-memory").textContent = "--";

    element("detail-disk").textContent = "--";

    element("detail-vision").textContent = "Unknown";
